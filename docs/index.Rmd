...
### Solution
Using historical yield data, clustering is used to detect homogeneous areas of the field in which each block of an experiment can be placed. See the [conceptual introduction](https://smmueller.github.io/plotdesignr/plotdesignr_introduce_concept.html) tab for more details.
